      ...
      >
        <div className="page-container">
          <div style={pill}>
            ...
            >
              <img src="/logo.png" alt="HarshaaDesignss" style={{ height: 220, width: 'auto', display: 'block', objectFit: 'contain' }} />
            </button>
          ...
          >
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center' }}>
                <img src="/logo.png" alt="HarshaaDesignss" style={{ height: 180, width: 'auto', display: 'block', objectFit: 'contain' }} />
              </div>
              <button
                onClick={() => setOpen(false)}
                style={{
