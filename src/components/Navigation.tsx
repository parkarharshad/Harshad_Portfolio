      ...
      >
        <div className="page-container">
          <div style={pill}>
            ...
            >
              <img src="/logo.png" alt="HarshaaDesignss" style={{ height: 110, width: 'auto', display: 'block', objectFit: 'contain' }} />
            </button>
          ...
          >
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center' }}>
                <img src="/logo.png" alt="HarshaaDesignss" style={{ height: 90, width: 'auto', display: 'block', objectFit: 'contain' }} />
              </div>
              <button
                onClick={() => setOpen(false)}
                style={{
