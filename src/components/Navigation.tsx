      ...
      >
        <div className="page-container">
          <div style={pill}>
            ...
            >
              <img src="/logo-v2.png" alt="HarshaaDesignss" style={{ height: 48, width: 'auto', display: 'block', objectFit: 'contain' }} />
            </button>
          ...
          >
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center' }}>
                <img src="/logo-v2.png" alt="HarshaaDesignss" style={{ height: 40, width: 'auto', display: 'block', objectFit: 'contain' }} />
              </div>
              <button
                onClick={() => setOpen(false)}
                style={{
